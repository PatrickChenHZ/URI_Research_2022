...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_HTU21D is
  ...
  signal delay_reg : STD_LOGIC_VECTOR ( 31 downto 9 );
  ...
  attribute SOFT_HLUTNM of \byte_len[0]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \myled[0]_i_4\ : label is "soft_lutpair0";
begin
...
\delay_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 1) => delay_reg(11 downto 9),
...
\myled[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\myled[0]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\myled[0]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\myled[0]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\myled[0]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFE0"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^data_write\ : STD_LOGIC_VECTOR ( 5 to 5 );
  signal \^myled\ : STD_LOGIC_VECTOR ( 0 to 0 );
...
begin
  ...
  byte_len(3) <= \<const0>\;
  byte_len(2) <= \<const0>\;
  byte_len(1) <= \^reg_addr\(1);
  byte_len(0) <= \^data_write\(5);
  counter_rst <= \<const0>\;
  data_write(7) <= \<const0>\;
  data_write(6) <= \<const0>\;
  data_write(5) <= \^data_write\(5);
  data_write(4) <= \^data_write\(5);
  data_write(3) <= \<const0>\;
  data_write(2) <= \^data_write\(5);
  data_write(1) <= \<const0>\;
  data_write(0) <= \<const0>\;
  dev_addr(7) <= \<const1>\;
  dev_addr(6) <= \<const1>\;
