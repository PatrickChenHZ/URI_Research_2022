...
/* synthesis syn_black_box black_box_pad_pin="enable,rw,mosi[15:0],miso[15:0],reg_addr[7:0],device_addr[6:0],divider[15:0],data[15:0],iic_rst,busy,instate,counter,counter_rst" */;
  output enable;
  output rw;
  output [15:0]mosi;
  input [15:0]miso;
