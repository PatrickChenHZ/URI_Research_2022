...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_htu21d is
  ...
  signal \proc_cntr_reg[4]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of counter_rstr_reg_i_2 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of counter_rstreg_reg_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of counter_rstreg_reg_i_2 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \data_reg[15]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of enable_reg_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of enable_reg_i_2 : label is "soft_lutpair1";
...
counter_rstr_reg_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0400"
    )
        port map (
...
counter_rstreg_reg_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00100000"
    )
        port map (
...
counter_rstreg_reg_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0C040000"
    )
        port map (
...
enable_reg_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"42000180"
    )
        port map (
...
\proc_cntr_reg[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BBBBFFFFFFFF7703"
    )
        port map (
      I0 => busy,
      I1 => proc_cntr(0),
...
\proc_cntr_reg[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"4040080801013322"
    )
        port map (
      I0 => proc_cntr(0),
      I1 => proc_cntr(4),
...
\proc_cntr_reg[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"30080C0000CB0000"
    )
        port map (
      I0 => counter,
      I1 => proc_cntr(0),
...
\proc_cntr_reg[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"300C000000880000"
    )
        port map (
      I0 => counter,
      I1 => proc_cntr(0),
...
\proc_cntr_reg[4]_i_2\: unisim.vcomponents.MUXF7
     port map (
      I0 => \proc_cntr_reg[4]_i_3_n_0\,
      I1 => \proc_cntr_reg[4]_i_4_n_0\,
      O => \proc_cntr__0\,
      S => proc_cntr(0)
    );
\proc_cntr_reg[4]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88111150"
    )
        port map (
...
\proc_cntr_reg[4]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"22447255"
    )
        port map (
