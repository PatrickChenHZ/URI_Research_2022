...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(cmd, iic_clk, iic_write, data_in, iic_status, clk, 
  iic_rst, led, state_debug)
/* synthesis syn_black_box black_box_pad_pin="cmd[7:0],iic_clk[15:0],iic_write[7:0],data_in[7:0],iic_status[7:0],clk,iic_rst,led[3:0],state_debug[3:0]" */;
  output [7:0]cmd;
  output [15:0]iic_clk;
