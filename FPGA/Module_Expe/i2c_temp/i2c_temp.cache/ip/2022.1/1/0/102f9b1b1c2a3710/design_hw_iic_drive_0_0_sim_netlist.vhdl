...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iic_drive is
  ...
  attribute FSM_ENCODED_STATES of \state_reg[0]\ : label is "SETUP:00001,WRITE:00010,END_WRITE:00011,READ:00100,END_READ:00101,IDLE:00110,iSTATE:00000";
  attribute FSM_ENCODED_STATES of \state_reg[1]\ : label is "SETUP:00001,WRITE:00010,END_WRITE:00011,READ:00100,END_READ:00101,IDLE:00110,iSTATE:00000";
  attribute FSM_ENCODED_STATES of \state_reg[2]\ : label is "SETUP:00001,WRITE:00010,END_WRITE:00011,READ:00100,END_READ:00101,IDLE:00110,iSTATE:00000";
begin
  read_en <= \^read_en\;
  send_en <= \^send_en\;
read_en_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFF555D00004444"
    )
        port map (
      I0 => state(0),
      I1 => state(2),
...
read_en_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
send_en_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF5D0044"
    )
        port map (
