...
HD_PWD='D:/Vivado_prj/i2c_temp/i2c_temp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmp_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmp_top.tcl
