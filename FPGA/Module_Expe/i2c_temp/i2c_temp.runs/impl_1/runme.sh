...
HD_PWD='D:/Vivado_prj/i2c_temp/i2c_temp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bmp_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bmp_top.tcl -notrace
