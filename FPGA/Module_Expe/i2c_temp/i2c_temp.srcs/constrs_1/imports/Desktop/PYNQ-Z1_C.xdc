...
#set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { ck_scl2 }]; #IO_L15N_T2_DQS_13 Sch=ck_io[38]
#set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { ck_sda2 }]; #IO_L14N_T2_SRCC_13 Sch=ck_io[39]
...
#set_property PULLUP true [get_ports ck_scl];
#set_property PULLUP true [get_ports ck_sda];
